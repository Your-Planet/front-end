		...
		<StyledContainerInSlogan>
			...
			<StyledFlexBoxInSlogan>
				...
				<Box className="flex animate-fade animate-duration-[1500ms] animate-delay-[1500ms] animate-ease-linear">
					<Typography fontFamily="Futura-pt-bold-oblique" className="ml-5 font-black text-[#b2ebc9]" variant="h1">
						C
					</Typography>
					<Typography fontFamily="Futura-pt-bold-oblique" className="font-black text-[#f5e89d]" variant="h1">
						O
					</Typography>
					<Typography fontFamily="Futura-pt-bold-oblique" className="font-black text-[#b9daf6]" variant="h1">
						L
					</Typography>
					<Typography fontFamily="Futura-pt-bold-oblique" className="font-black text-[#e5adc0]" variant="h1">
						O
					</Typography>
					<Typography fontFamily="Futura-pt-bold-oblique" className="font-black text-[#ffb347]" variant="h1">
						R
					</Typography>
				</Box>
			</StyledFlexBoxInSlogan>

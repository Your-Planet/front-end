	...
	return (
		<Box className="w-full h-auto px-[100px] relative opacity-0" ref={refBox}>
			<Box className="flex flex-col items-center justify-center w-full h-except-header">
				...
				<Box className="flex items-center overflow-hidden bg-white px-[60px] h-[300px] whitespace-nowrap relative before:absolute before:top-0 before:w-[300px] before:h-full before:content-none before:z-10 before:left-0 after:absolute after:top-0 after:w-[300px] after:h-full after:content-none after:z-10 hover:pause">

...
import StudioProfileCardPreview from "@/components/mypage/studio/StudioProfileView/components/StudioProfilePreview/components/card/StudioProfileCardPreview";
import StudioProfilePortfolioPreview from "@/components/mypage/studio/StudioProfileView/components/StudioProfilePreview/components/portfolio/StudioProfilePortfolioPreview";
import {
	STUDIO_FORM_WIDTH,
	STUDIO_PROFILE_GAP,

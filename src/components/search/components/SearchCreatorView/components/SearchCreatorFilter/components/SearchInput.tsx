...
import {
	SEARCH_BY_BOX_WIDTH,
	SEARCH_BY_LABEL,
} from "@/components/search/components/SearchCreatorView/components/SearchCreatorFilter/defines/constants";
import { SearchByType } from "@/components/search/components/SearchCreatorView/components/SearchCreatorFilter/defines/type";

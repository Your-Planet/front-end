...
import { SearchAuthorFilterProps } from "@/components/search/components/SearchAuthorView/components/SearchAuthorFilter/defines/types";
...
export interface CategoryProps
	extends Pick<
		SearchAuthorFilterProps,
		"selectedCategories" | "splitCategoriesFromSearchParams" | "onChangeCategories"
	> {}

			...
			<Box className="relative text-center z-[99] cursor-default pointer-events-none">
				<Box className="w-full h-full flex items-center justify-center mx-0 my-[10px]">
					<Box
						...
						onClick={handleClick}
					>
						<Box className="w-[35px] h-[60px] border-2 border-solid border-[#657385] rounded-[60px] relative before:content-[''] before:w-[8px] before:h-[8px] before:absolute before:top-[8px] before:left-2/4 before:translate-x-[-50%] before:bg-[#657385] before:rounded-[50%] opacity-100 before:animate-wheel" />
